package com.nicht.promote.fileservice.SimapleChat.CommandBeans;
...
public class WatchConstant {
    ...
    public  interface  UploadSecProCode{
        ...
        String   UploadFileDataResponse="07";//服务器下发上传文件内容应答
    ...
    public  interface CenterReplyCommand{
        /**收到文件上传请求 回复下发文件标识*/
        String  FileRequestReply = HexUtil.encodeHexStr("*LOLAT") + "05" + "0800" + HexUtil.encodeHexStr(Long.toString(ByteUtils.getFileTicket())) + HexUtil.encodeHexStr("#");
        /*日常签到回复签到成功*/
        String  DailySignInReply =  HexUtil.encodeHexStr("*LOLAT") + "11" + "0200" + HexUtil.encodeHexStr("OK#");
        /*回复文件接受成功*/
        String  UploadFileReply = HexUtil.encodeHexStr("*LOLAT") + "07" + "0800" + HexUtil.encodeHexStr(Long.toString(ByteUtils.getFileTicket())) + HexUtil.encodeHexStr("#");
    }
