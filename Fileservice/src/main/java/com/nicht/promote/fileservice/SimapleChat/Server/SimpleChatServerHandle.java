...
public class SimpleChatServerHandle implements ChannelInboundHandler {   /*TextWebSocketFrame*/
            ...
            if (!WatchConstant.UploadSecProCode.UploadFileData.equals(watchmsg.getSecpro())) {
                switch (watchmsg.getSecpro()){
                    ...
                    case   WatchConstant.UploadSecProCode.UploadFileData:
                        ...
                        ByteUtils.byte2image(ByteUtils.Byf2Bytes(ByteUtils.bytes2Bytebuf(watchmsg.getBytesdata())), "D://360Downloads//" + watchmsg.getFileInfo().getFile_name());
                    default: break;
